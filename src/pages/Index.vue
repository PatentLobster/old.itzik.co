...
<div class="grid">
  ...
  <div class="card">
    ...
    <div class="card-text">
        <p>
            I am an experienced full-stack developer, and I have extensive knowledge in a wide array of web-technologies.
        </p>
        <p>
            I like to code things from scratch, enjoy bringing ideas to life, and to provide solutions for real issues with code.
        </p>
      </div>
